    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoPartOrders", x => new { x.AutoPartsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_AutoPartOrders_AutoParts_AutoPartsId",
                        column: x => x.AutoPartsId,
                        principalTable: "AutoParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutoPartOrders_Orders_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoPartOrders_OrdersId",
                table: "AutoPartOrders",
                column: "OrdersId");
